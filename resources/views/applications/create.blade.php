...
<h1 class="h4 mb-1">Apply for aid</h1>
<p class="text-muted small mb-3">
    This creates a draft. You can upload your documents and submit on the next screen.
</p>
...
<form method="POST" action="{{ route('applications.store') }}" class="card">
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            <label for="aid_program_slug" class="form-label">Programme</label>
    ...
    <div class="card-footer d-flex justify-content-end gap-2">
        ...
        <button type="submit" class="btn btn-aidbridge">Create draft</button>
    </div>
</form>
@endif
